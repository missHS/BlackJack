...
public class BJFrame extends JFrame {
	...
	public BJFrame() {
		...
		scoreBoardTextD.setFont(new Font("Verdana", Font.PLAIN, 16));
		scoreBoardTextD.setBackground(new Color(255, 250, 240));
		scoreBoardTextD.setBounds(10, 11, 139, 116);

		scoreBoard.add(scoreBoardTextD);
		scoreBoardTextP.setFont(new Font("Verdana", Font.PLAIN, 16));
		scoreBoardTextP.setBackground(new Color(255, 250, 240));
		scoreBoardTextP.setBounds(169, 11, 139, 116);

		scoreBoard.add(scoreBoardTextP);
		messageText.setBounds(10, 157, 298, 35);
		scoreBoard.add(messageText);
		messageText.setFont(new Font("Verdana", Font.PLAIN, 20));
